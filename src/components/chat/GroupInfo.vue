            ...
            <ul class="flex text-center add-friend-dialog-bot">
              <li>
                <div class="add-friend-dialog-number">
                  <!-- v1-v5五个png文件，都没有，详图见2020-5-26 13:46的提交记录 -->
                  <!-- <div v-if="userInfo.level == null">
                    <img src="../../assets/images/v1.png" width="20px" alt />
                  </div>
                  <div v-else>
                    <img :src="require('../../assets/images/v' + userInfo.level + '.png')" width="20px" alt />
                  </div> -->
                </div>
                <div class="add-friend-dialog-word">等级</div>
              </li>
              <li>
                <div class="add-friend-dialog-number">
                  {{ userInfo.computingPower }}
                </div>
                <div class="add-friend-dialog-word">算力</div>
              </li>
              <li>
                <div class="add-friend-dialog-number">{{ userInfo.invitationCount }}篇</div>
                <div class="add-friend-dialog-word">看法</div>
              </li>
            </ul>
            <div class="add-friend-dialog-btns">
              <slot v-if="userInfo.isFriend">
                <el-button @click="handSendMes(userInfo)" style="background-color:#2F54EB;width: 48%" type="info">发送消息</el-button>
